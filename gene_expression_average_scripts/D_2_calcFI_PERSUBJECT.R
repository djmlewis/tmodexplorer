# rna <- read_rds("D1_v3/rna")
calcFI <- function() {
  rna <- read_rds(
    paste0("D1_v3/outputs/", fname, ".rds"))
  ...
  write_rds(fi, paste0("D1_v3/outputs/",fname,"_FI_EACHSUBJECT.rds"))
...
# write_rds(read_csv("D1_v3/normalized_expression_values_ghent1_v3_limma"),path = "D2/outputs/limma.rds")
# write_rds(read_csv("D1_v3/normalized_expression_values_ghent1_v3_agilent"),path = "D2/outputs/agilent.rds")
# write_rds(read_csv("D1_v3/targets_metadata_ghent_1_v3.csv"),path = "D2/outputs/targets.rds")
# write_rds(read_csv("D1_v3/annotation_ghent_1_v3.csv"),path = "D2/outputs/annotation.rds")

################## SCRIPT
rm(list = setdiff(ls(), lsf.str()))

# load DM and filter out control wells
dm <- read_rds("D1_v3/outputs/targets_DM.rds") %>%
